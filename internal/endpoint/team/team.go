...
type Endpoints struct {
	...
	GetTournamentTeamVsTeamTable  endpoint.Endpoint
	GetTournamentsTeamVsTeamTable endpoint.Endpoint
...
func MakeEndpoints(s team.IService) Endpoints {
	return Endpoints{
		...
		GetTournamentTeamVsTeamTable:  makeGetTournamentTeamVsTeamTable(s),
		GetTournamentsTeamVsTeamTable: makeGetTournamentsTeamVsTeamTable(s),
		Create:                        makeCreate(s),
		Update:                        makeUpdate(s),
		Delete:                        makeDelete(s),
