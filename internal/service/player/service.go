...
func buildFullPlayer(player entities.Player, matches []entities.PlayersMatch, leagues []entities.PlayersLeague, games []entities.Game) entities.FullPlayer {
