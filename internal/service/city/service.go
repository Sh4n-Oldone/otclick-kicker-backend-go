...
type IService interface {
	GetList(ctx context.Context, withDeleted bool) ([]entities.City, error)
	Create(ctx context.Context, city entities.City) (*int64, error)
	Update(ctx context.Context, city entities.City) error
