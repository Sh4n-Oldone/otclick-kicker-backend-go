...
const (
	...
	queryCreateTournamentRatingInsertIgnore = `INSERT INTO tournament_rating (player_id, tournament_id, value) VALUES ($1, $2, $3) ON CONFLICT (player_id, tournament_id) DO UPDATE SET value = $3;`
